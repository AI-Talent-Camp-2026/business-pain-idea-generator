...
| **Макс Бржевский** | Hacker,Hipster | Разработка, архитектура, техническая реализация, Дизайн, UX/UI, пользовательский опыт |
| **Джамал Ибрашов** | Hacker | Разработка, архитектура, техническая реализация |

---


## Подробная проработка идеи в папке ./lead_canvas
